...
namespace BalangaAMS.ApplicationLayer.Report
{
    ...
    /// </summary>
    public partial class IndividualMonthyAttendanceReport : Telerik.Reporting.Report
    {
        private readonly DataTable _reportTable;
        private readonly IndividualReportSummary _reportSummary;
        TableGroup _columngroup;
        TextBox _txtcolumn;
        PictureBox _picbody;
        TextBox _txtbody;

        public IndividualMonthyAttendanceReport(DataTable reportTable, IndividualReportSummary reportSummary, string localName)
        {
